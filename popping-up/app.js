...
const LYRICS = [
  ...
  { text: "Wait till the fog rolls in" },
  { text: "And you can't see the waves, a coming" },
  { text: "Where ya gonna go, stuck out at sea" },
  { text: "Pop pop popping up" },
  { text: "Pop pop popping up" },
  ...
  { text: "I was so scared I’d break my leash" },
  { text: "And drown, in the washing machine, right in the city" },
  { text: "Somehow, I held on, for dear life" },
  { text: "I had to, pop pop popping up" },
  { text: "Pop pop popping up" },
