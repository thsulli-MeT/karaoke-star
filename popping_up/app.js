...
const LYRICS = [
  ...
  { text: "Gonna, Pour it," },
  { text: "Out while I have something to give" },
  { text: "Pour it out" },
  { text: "I've got something to prove" },
  { text: "I can see my whole life story" },
  { text: "Flashing right before me" },
  { text: "I better do this now" },
  { text: "While I’m in the mood" },
  { text: "Here’s what I’m gonna do" },

  { text: "" },
  { text: "Figured it was gonna be my last chance" },
  { text: "To really work this hard" },
  { text: "Pushing my limits" },
  { text: "Let's see where that takes us" },
  { text: "From the beginning that was my motto" },
  ...
  { text: "But I felt like I was staring right at the streets" },
  { text: "If things didn't go just as planned" },
  { text: "Here’s what I’m gonna do" },
  { text: "Gonna, Pour it out" },
  { text: "And let you in on it" },
  { text: "Gonna, Pour it out" },
  { text: "Gonna, Pour it out" },

  { text: "" },
  { text: "If I've learned anything" },
  { text: "At this point, it is" },
  { text: "You can't always judge a book by its cover" },
  { text: "What’s under the skin" },
  { text: "Is so hard to imagine" },
  { text: "When you can't look past the stereotype" },
  { text: "Let’s try and break that trend" },
  { text: "And let all the people shout" },
  { text: "Here’s what I’m gonna do" },
  { text: "Gonna, Pour it out" },
  { text: "And you are in on it" },
  { text: "Gonna, Pour it out" },
  { text: "Gonna, Pour it out" },
  { text: "Gonna, Pour it out" }
];
