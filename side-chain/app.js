...
const DEFAULT_LYRICS = {
  ...
  "Pour It Out - Sample": [
    ...
    "Gonna, Pour it, out while I have something to give",
    "Pour it out, I've got something to prove",
    "I can see my whole life story flashing right before me",
    "i better do this now, while Im in the mood",
    "Heres what Im gonna do",
    "Gonna, Pour it out",
    "Gonna, Pour it out, here's some more",
    "",
    "Figured it, was gonna be my last chance, to really work this hard",
    "push my limits, see where that takes us",
    "from the beginning that was my motto, and it continues",
    "Here's what I'm gonna do",
    "Gonna, Pour it",
    "Gonna, Pour it out, for you",
    "",
    "I found my inspiration, it was my, desperation",
    "you think I'm joking but I felt like I was staring right at the streets",
    "if things didn't go just as planned",
    "Here's what Im gonna do",
    "Gonna, Pour it out, and let you in on it",
    "Gonna, Pour it out",
    "Gonna, Pour it out",
    "",
    "If i've learned anything, at this point, it is",
    "you cant, always, judge a book by its cover",
    "what’s under the skin is so hard to imagine",
    "when you can't look past, the stereotype",
    "lets try and that break that trend, and let all the people shout",
    "Here’s what Im gonna do",
    "Gonna, Pour it out, and you are in on it",
    "Gonna, Pour it out",
    "Gonna, Pour it out",
    "Gonna, Pour it out",
  ].join("\n"),
