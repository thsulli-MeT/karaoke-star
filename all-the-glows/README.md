# All The Glows drop-in song files

`All The Glows` is now pre-registered in Side-Chain as a drop-in song entry.
...
Tip: use the provided background image as one of the supported artwork names above.
