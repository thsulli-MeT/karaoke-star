...
const LYRICS = [
  ...
  { text: "I keep saying — listen to my words" },
  { text: "Oh oh oh — listen to my words" },
  ...
  { text: "" },
  { text: "Been asking Joe — remembering the story" },
  ...
  { text: "Listen to my words — oh oh — listen to my words" },
  { text: "It’s not automatic" },
  { text: "But it is free flowing when I get it going" },
  { text: "Listen to my words" },
