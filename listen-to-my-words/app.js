...
const LYRICS = [
  ...
  { text: "Watch my actions, Jackson" },
  { text: "These lyrics, won’t just write themselves" },
  { text: "Gotta pull them out, of the ether" },
  { text: "Those machines, don't really know my feelings, do they?" },
  { text: "For now — just listen to my words" },
  { text: "Listen to my words" },
  { text: "To my words" },
  { text: "Follow for sure — to get a subscription" },
  { text: "Then you can find out" },
  { text: "It’s been Me T, manipulating" },
  { text: "He knows, how to, push all them buttons" },
  { text: "To get the gen’s best reactions" },
  { text: "From the top — somehow, we connected" },
  { text: "An electric muse" },
  { text: "I keep saying — listen my words" },
  { text: "Oh oh oh — listen to my words,listen to my words,listen my words" },
  { text: "And then judge for yourself" },
  { text: "Not just a knee jerk reaction" },
  { text: "Listen to my words" },
  { text: "Ah — listen to my words" },

  { text: "" },
  { text: "yo, Been asking Joe — remembering the story" },
  { text: "About John Henry" },
  { text: "Like a rapper — I can spit it out" },
  { text: "But not under, so much pressure" },
  { text: "Not yet" },
  { text: "Listen my words" },
  { text: "Watch my actions from here on out" },
  { text: "I can hear, something in my head" },
  { text: "That says — write it down, quick quick" },
  { text: "Soon enough, you will be dead" },
  { text: "Listen my words — oh oh — listen to my words" },
  { text: "It’s not automatic" },
  { text: "But it's free flowing when I get it going" },
  { text: "Listen to my words" },
  { text: "I’m not begging — but baby baby please" },
  { text: "Listen to my-words" },
  { text: "Listen to my-words, my words, my words, my words" },

  { text: "" },
  { text: "Dude — I went all the way in" },
  { text: "Took a trip to, F N — fantasy island" },
  { text: "To pick up, all this garbage rolling around, in my head" },
  { text: "Listen to my words" },
  { text: "Listen to my words" },
  { text: "They already have rhythm" },
  { text: "Ah,ah,ah — listen — my words" },
  { text: "Sometimes I go so fast I do make type-ohs" },
  { text: "Sometimes it just works" },
  { text: "Listen to my-words, my words, my words " },
  { text: "Listen to my words — carefully" },

  { text: "" },
  { text: "3 to 1 — now the odds are stacked in my favor" },
  { text: "Listen to my words" },
  { text: "Soon enough it will be twenty twenty six — then 7" },
  { text: "Notice — I didn't say it — ha ha" },
  { text: "But you catchn my drift" },
  { text: "Listen to my words" },
  { text: "Carefully, crafted — like fine wine" },
  { text: "It’s been aging so gracefully" },
  { text: "Now that I’ve recovered" },
  { text: "From the intentional — and the accidents" },
  { text: "Oh — listen to my words" },
  { text: "Oh — listen to my words" },
  { text: "If you didn’t catch it all — roll it back, Jack" },
  { text: "Listen my-words" },
  { text: "Next time — listen to my words" }
];
