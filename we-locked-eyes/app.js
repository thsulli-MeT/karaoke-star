...
const LYRICS = [
  ...
  { text: "Beauty has a way of doing that, when" },
  { text: "we locked eyes" },
  { text: "It was I" },
  ...
  { text: "Fantasy, has a way of transforming a man’s direction, opinion" },
  { text: "don’t let that get in the way" },
  ...
  { text: "we locked eyes" },
  { text: "we locked eyes — you had me" }
];
